...
//        if(name=="") {
//            Toast.makeText(SecondActivity.this, "Сначла введите название!", Toast.LENGTH_LONG).show();
//            return;
//        } else mT1.setText(name);
//        if(description=="") {
//            Toast.makeText(SecondActivity.this, "Сначла введите описание!", Toast.LENGTH_LONG).show();
//            return;
//        } else mT2.setText(description);
//        if(date=="") {
//            Toast.makeText(SecondActivity.this, "Сначла введите дату!", Toast.LENGTH_LONG).show();
//            return;
//        } else mT3.setText(date);
//        if(time=="") {
//            Toast.makeText(SecondActivity.this, "Сначла введите время!", Toast.LENGTH_LONG).show();
//            return;
//        } else mT4.setText(time);
